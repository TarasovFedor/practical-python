...
def parse_csv(
        iterable: Iterable, select: list[str] = [], types: list[Type[Any]] = [], has_headers: bool = False, delimeter: str = ','
...
if __name__ == '__main__':
    with open('Work/Data/portfolio.csv') as file:
        portfolio = parse_csv(file, has_headers=False, select=['name'], types=[str, int, float])
    print(portfolio)
